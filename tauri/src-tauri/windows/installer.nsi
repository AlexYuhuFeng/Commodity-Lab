...
!define REPOSITORYURL "https://github.com/AlexYuhuFeng/Commodity-Lab"
...
!define MUI_FINISHPAGE_TEXT "Commodity Lab has been installed.$\r$\n$\r$\nDeveloper: 天然气中心$\r$\nRepository: ${REPOSITORYURL}$\r$\n$\r$\n🎵疯狂疯狂星期四，原味鸡两块九块九🎵"
!define MUI_FINISHPAGE_LINK "GitHub: AlexYuhuFeng/Commodity-Lab"
!define MUI_FINISHPAGE_LINK_LOCATION "${REPOSITORYURL}"
...
Section Install
  ...
  WriteRegStr SHCTX "${UNINSTKEY}" "URLInfoAbout" "${REPOSITORYURL}"
  WriteRegStr SHCTX "${UNINSTKEY}" "URLUpdateInfo" "${REPOSITORYURL}"
  WriteRegStr SHCTX "${UNINSTKEY}" "HelpLink" "${REPOSITORYURL}"
